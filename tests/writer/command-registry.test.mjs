...
test("maps Word-facing semantic commands to verified LibreOffice dispatch URLs", () => {
  ...
  assert.deepEqual(
    JSON.parse(JSON.stringify(registry)),
    {
      ...
      "format.toggleStrikethrough": ".uno:Strikeout",
      "format.toggleSubscript": ".uno:SubScript",
      "format.toggleSuperscript": ".uno:SuperScript",
      "format.clearFormatting": ".uno:ResetAttributes",
